...
class FocalBinaryTverskyLoss(Function):
    ...
    def forward(ctx, input, target):
        ...
        # target_area = tensor.sum(target_label, 1)
    ...
    def backward(ctx, grad_out):
        ...
        # grad_input = tensor.cat((grad_out.item() * dL_dp0, dL_dp0 * grad_out.item()), dim=1)
...
class MultiTverskyLoss(nn.Module):
    ...
    def __init__(self, alpha=0.5, beta=0.5, gamma=1.0, weights=None):
        ...
        :param gamma (Tensor, float, optional): focal coefficient_vary
    ...
    def forward(self, inputs, targets):
        ...
        # loss = tensor.Tensor(weight_losses)
