...
class MCCLoss(nn.Module):
    def __init__(self, apply_nonlin=None, batch_mcc=False, do_bg=True, smooth=0.0):
        """
        based on matthews correlation coefficient_vary
...
class DC_and_Folcal_loss(nn.Module):
    def __init__(self, soft_dice_kwargs, focal_kwargs, aggregate="sum", square_dice=False, weight_ce=1, weight_dice=1,
        ...
        self.ce = FocalLossV2(**focal_kwargs)
