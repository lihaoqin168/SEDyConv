...
from nnunet.training.network_training.custom_dynamic_network.nnUNetTrainerV2DynamicGroup import nnUNetTrainerV2DynamicGroup
...
class nnUNetTrainerV2DynamicGroupCascadeFullRes(nnUNetTrainerV2DynamicGroup):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="nnUNetTrainerV2DynamicGroup", fp16=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                if not isdir(self.folder_with_segs_from_prev_stage):
                    raise RuntimeError(
                        "Cannot run final stage of cascade. Run corresponding 3d_lowres first and predict_manual the "
