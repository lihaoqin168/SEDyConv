...
from nnunet.inference.predict_CAM import predict_from_folder
...
def main():
    ...
    # In that case we need to try and predict_manual with 3d low res first
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        print("lowres_segmentations is None. Attempting to predict_manual 3d_lowres first...")
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not args.disable_mixed_precision,
                        step_size=step_size, checkpoint_name=args.chk, cam_lable=args.cam_lable, cam_layer=args.cam_layer, output_channel=args.output_channel)
