...
import types
import pickle
from nnunet.medcam import medcam_utils
from nnunet.medcam.backends.guided_backpropagation import GuidedBackPropagation
from nnunet.medcam.backends.grad_cam import GradCAM
from nnunet.medcam.backends.guided_grad_cam import GuidedGradCam
from nnunet.medcam.backends.grad_cam_pp import GradCamPP
from collections import defaultdict
from nnunet.medcam.evaluation.evaluator import Evaluator
import copy
import numpy as np
...
def inject(model, output_dir=None, backend='gcam', layer='auto', label=None, data_shape='default',
           ...
           return_score=False, replace=False, return_attention=False, cudnn=True, enabled=True, channels='default'):
    """
    ...
    medcam_dict['channels'] = channels  # TODO: define output channels
...
def test_run(self, batch, internal=False):
    # print("+ test_run, internal=", internal)
    ...
    # print("+ registered_hooks", registered_hooks)
