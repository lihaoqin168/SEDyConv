...
from nnunet.medcam.backends.base import _BaseWrapper
...
class GradCAM(_BaseWrapper):
    ...
    def _register_hooks(self):
        print("+ _register_hooks(), Registers the forward and backward hooks to the layers.")
    ...
    def get_registered_hooks(self):
        # print("+ self.registered_hooks:", self.registered_hooks)
        ...
        for layer in self.registered_hooks.keys():
            if self.registered_hooks[layer][0] and self.registered_hooks[layer][1]:
                print("registered_hooks append layer", layer)
    ...
    def generate(self):
        # print("+ self.target_layers:", self.target_layers)
        # print("+ self._target_layers:", self._target_layers)
    ...
    def _check_hooks(self, layer):
        # print("+ _check_hooks:", layer)
        # print("+ self.registered_hooks:", self.registered_hooks)
        # print("+ self.registered_hooks[layer]:", self.registered_hooks[layer])
        # print("+ self.registered_hooks[layer][1]:", self.registered_hooks[layer][1])
