...
class ExperimentPlanner3D_v21_24GB(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill a V100 (32GB) in fp16
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_24GB, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # to be used
        ref = Generic_UNet.use_this_for_batch_size_computation_3D * 24 / 8  # 8 instead of 8.5 because YOLO
        ...
        print("++  here", here)
        print("++  ref", ref)
        print("++  np.floor(max(ref / here, 1)", np.floor(max(ref / here, 1)))
        ...
        print("++ new max_batch_size", max_batch_size)
