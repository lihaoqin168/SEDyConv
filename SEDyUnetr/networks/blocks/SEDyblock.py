...
class SEDyConv(nn.Module):
    def __init__(self, in_channels, out_channels, dyAttBlocks, reduction=0.0625, kernel_num=5, stride=1, dilation=1, bias=None, kernel_size=[3,3,3], padding=[1,1,1], groups=1,
        ...
        self.visul_flg = False
        self.count_num = 0
        self.flg = 0
        self.rnd = random.randint(1, 500)
        ...
        self.out_in = nn.InstanceNorm3d(out_channels)
    ...
    def _forward_impl_common(self, x):
        ...
        if self.dyAttBlocks_flg:
            ...
            print("++ all switch closed, x.shape", x.shape)
        ...
        for i in range(self.kernel_num):
            ...
            outputx = outputx * filter_attention
            outputx = self.out_in(outputx)
